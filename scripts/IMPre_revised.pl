...
=head1 [parameters]
	...
	-j_lf        <I> the minimum length for output [40]
	       ...
	       ****    Annotation     *************
	-known_v	<S> Known germline sequences file. uesd for annotation. FASTA format,(the id should be like this: germline_name_flag_specie, such as TRBV1-1*01_F_Human)
	-known_j	<S> Known germline sequences file. uesd for annotation. FASTA format,(the id should be like this: germline_name_flag_specie, such as TRBV1-1*01_F_Human)
...
my ($known_germ_v, $known_germ_j, $re_v_mis, $re_j_mis);
...
GetOptions(
		...
		"v_min_e:i" => \$v_min_e,
		"j_min_e:i" => \$j_min_e,
		"known_v:s" => \$known_germ_v,
		"known_j:s" => \$known_germ_j,
		"re_v:i" => \$re_v_mis,
		"re_j:i" => \$re_j_mis
	  );
...
if(defined($known_germ_v) or defined($known_germ_j))
{
